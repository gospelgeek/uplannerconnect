...
*/
function grade_deleted() {
   
   try {
      print_r("grade_deleted");
   } 
   catch (Exception $e) {
      error_log('Excepción capturada: ',  $e->getMessage(), "\n");
   }
