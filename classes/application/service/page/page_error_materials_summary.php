 ...
 * Data Page Index
 */
class page_error_materials_summary extends page
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $title = 'Materials Error Summary';
    ...
    {
        $this->url = new moodle_url('/local/' . plugin_config::PLUGIN_NAME . '/routes/error_materials_summary.php');
    }
    ...
    public function get_data()
    {
        ...
        try {
            $data->row = [];
            $repository = new material_repository();
            $dataQuery = [
